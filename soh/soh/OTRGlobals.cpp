    ...
    render:
        ...
        if (extractionTask.has_value()) {
            ...
            if (status == std::future_status::ready) {
                ...
                if (!ImGui::IsPopupOpen(SohGui::TrLabel("ROM Extraction").c_str())) {
                    ImGui::OpenPopup(SohGui::TrLabel("ROM Extraction").c_str());
                }
                ...
                if (ImGui::BeginPopupModal(SohGui::TrLabel("ROM Extraction").c_str(), NULL,
